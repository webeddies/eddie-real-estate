export const properties = [
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Impressive 4-bedroom family home in Abuakwa, one of Kumasi's developing residential suburbs. This spacious property features 5 bathrooms including a guest washroom, making it perfect for larger families. Built on a generous 450 sqm plot, the home offers quality construction, modern finishes, and room for outdoor activities. Abuakwa provides a peaceful residential environment with improving infrastructure, good schools, and growing commercial activities. An excellent investment in Kumasi's expanding property market.",
    amenities: [
      "Spacious Compound",
      "All Bedrooms En-suite",
      "Guest Washroom",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Comfortable 4-bedroom home in the established New Achimota area. This property offers practical family living with 3 bathrooms and well-proportioned rooms. New Achimota is known for its proximity to top international schools, the Achimota Mall, and the Achimota Forest Reserve. The neighborhood features mature infrastructure, reliable utilities, and good security. Perfect for families seeking a convenient location with access to quality education, shopping, and recreational facilities in a peaceful residential setting.",
    amenities: [
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Well-maintained 3-bedroom apartment in Asokore Mampong, a growing residential area in Kumasi. This property offers affordable rental accommodation with all bedrooms en-suite, modern finishes, and adequate living space. The location provides good access to the city center, Kumasi Airport, and major commercial areas. Perfect for professionals, small families, or those relocating to Kumasi who want comfortable housing at a reasonable rate in a developing neighborhood with improving amenities.",
    amenities: [
      "Gated Compound",
      "All Bedrooms En-suite",
      "Modern Kitchen",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Stunning 4-bedroom luxury home in the scenic Peduase valley, known as the 'Aburi of the East'. This property offers breathtaking mountain views, cool climate, and serene surroundings perfect for a weekend retreat or permanent residence. The home features contemporary design, quality finishes, and expansive windows that bring the outdoors in. Peduase is rapidly becoming a premium residential area for those seeking escape from city heat while remaining accessible to Accra. An exceptional property for discerning buyers.",
    amenities: [
      "Mountain Views",
      "Cool Climate",
      "All Bedrooms En-suite",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Contemporary 2-bedroom apartment in the upscale Ashaley Botwe neighborhood. This property offers modern urban living with quality finishes, spacious rooms, and a large compound. Ashaley Botwe has become one of Accra's sought-after residential areas with excellent road infrastructure, shopping centers, international schools, and restaurants. Perfect for expatriates, young professionals, or couples seeking a comfortable lifestyle in a well-planned community with reliable utilities and good security.",
    amenities: [
      "Prime Location",
      "Both Bedrooms En-suite",
      "Modern Fitted Kitchen",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Modern 3-bedroom home in Oyibi, a rapidly developing suburb of Greater Accra. This property features contemporary design with all bedrooms en-suite, a functional kitchen, and comfortable living spaces. Oyibi offers affordable homeownership with good growth potential as the area continues to develop with new roads, shopping centers, and improved utilities. Perfect for first-time buyers, young families, or investors seeking capital appreciation in an emerging neighborhood with easy access to both Accra and Tema.",
    amenities: [
      "Modern Construction",
      "All Bedrooms En-suite",
      "Kitchen with Cabinets",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Stylish 2-bedroom short-stay apartment in Lashibi, perfect for business travelers and tourists. This fully furnished property offers comfortable accommodation with modern amenities, self-catering facilities, and a homely atmosphere. Located near the Tema Motorway with easy access to the airport, Tema Port, and Accra's business districts. The apartment features contemporary decor, reliable WiFi, and all necessary conveniences for a comfortable stay. Ideal for short-term visitors to Greater Accra.",
    amenities: [
      "Fully Furnished",
      "Both Bedrooms En-suite",
      "Self-Catering Kitchen",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Elegant 4-bedroom home in the picturesque town of Akosombo, famous for the Volta Dam and stunning lake views. This property combines modern comfort with the tranquility of waterside living. Perfect as a vacation home, retirement residence, or rental investment in Ghana's premier tourism destination. The home features quality construction, all bedrooms en-suite, and sits in a quiet neighborhood. Akosombo offers a unique lifestyle with water sports, boating, and a peaceful environment away from city noise.",
    amenities: [
      "Lakeside Location",
      "All Bedrooms En-suite",
      "Modern Kitchen",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Compact and charming 2-bedroom short-stay apartment within the exclusive Lakeside Estate. This cozy property offers serene water views, estate amenities, and a peaceful environment perfect for relaxation. Despite its compact size, the apartment is well-designed with 3 bathrooms and modern furnishings. Guests enjoy access to the estate's swimming pool, gym, and security services. Ideal for couples, small families, or business travelers seeking tranquil accommodation in one of Accra's most beautiful residential estates.",
    amenities: [
      "Lakeside Estate",
      "Water Views",
      "Fully Furnished",
  ...
  },
  {
    ...
    additionalImages: ["", "", "", "", ""],
    description: "Affordable 1-bedroom apartment on a generous plot in Pobiman. This budget-friendly rental offers basic comfortable accommodation perfect for single professionals, students, or those seeking economical housing in Greater Accra. The large compound size provides outdoor space and parking convenience. Pobiman is a developing area with improving infrastructure and affordable living costs. This property represents excellent value for money for tenants on a budget who need functional housing without frills.",
    amenities: [
      "Large Compound (410 sqm)",
      "1 Bedroom En-suite",
      "Kitchen Space",
      "Living Area",
      "Tiled Floor",
