...
const Home: React.FC = () => {
  ...
  return (
    <div className="font-inter">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
          <motion.h1
            ...
            className="text-3xl md:text-5xl font-bold text-white uppercase mb-6 bg-gradient-to-r from-white via-yellow-100 to-yellow-200 text-transparent bg-clip-text drop-shadow-md"
          >
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
              <div className="group text-center">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:bg-white/15 hover:border-white/30">
                  ...
                  <h3 className="text-2xl font-medium mb-4 text-white">Expert Consultation</h3>
              ...
              <div className="group text-center">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:bg-white/15 hover:border-white/30">
                  ...
                  <h3 className="text-2xl font-medium mb-4 text-white">Verified Property Search</h3>
                  <p className="text-white/80 font-light leading-relaxed">
              ...
              <div className="group text-center">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:bg-white/15 hover:border-white/30">
                  ...
                  <h3 className="text-2xl font-medium mb-4 text-white">Secure Transaction</h3>
                  <p className="text-white/80 font-light leading-relaxed">
      ...
      {/* Property Categories */}
      <section className="py-20 text-white relative" style={{ backgroundColor: '#2C3E50' }}>
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Property Categories</h2>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: categoryImages[category.name] ? `url(${categoryImages[category.name]})` : 'none'
                    }}
                  />
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-normal mb-6">Your Next Chapter Starts Here</h2>
