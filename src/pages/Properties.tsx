        ...
        <div className={`${showFilters ? 'block' : 'hidden'} lg:block w-full lg:w-80 flex-shrink-0`}>
          <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
            ...
            <div className="relative">
              ...
              {/* Optional icon - only if you use one */}
              <span className="absolute left-3 top-10 text-gray-400 pointer-events-none">
                {/* Replace with your actual icon (e.g., a house icon) */}
                🏠
              </span>
              ...
              <select
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-royal-blue focus:border-transparent"
              >
                <option value="">All</option>
